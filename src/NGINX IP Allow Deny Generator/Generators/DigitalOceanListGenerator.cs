...
public sealed class DigitalOceanListGenerator : IListGenerator
{
    private const string _url = "https://digitalocean.com/geo/google.csv";

    private static readonly HttpClient _client;

    static DigitalOceanListGenerator()
    {
